...
>(({ id, className, children, config, ...props }, ref) => {
  ...
  // Apply CSS variables directly to the chart container
  const lightVariables = generateCSSVariables('light')
  const darkVariables = generateCSSVariables('dark')

  // Combine all CSS variables for both themes
  const allVariables = { ...lightVariables, ...darkVariables }
...
// ChartStyle component removed - CSS variables are now applied directly to the container
